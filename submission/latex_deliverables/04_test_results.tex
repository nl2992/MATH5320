...
No-network tests & \textbf{610 passed, 0 failed, 0 skipped} \\
Statement Coverage & \textbf{96\%} \\
...
\textbf{No-network suite:} 610 tests passed, 0 failed, 0 skipped.

\textbf{Coverage:} 96\% statement coverage across \code{src/}; remaining
...
Market data               & \code{test\_market\_data.py}                              & 24  & 0 & 0 & CSV loader, yfinance wrappers, cache, rate helper \\
Config / validation       & \code{test\_config\_and\_validation.py}                  & 10  & 0 & 0 & Input and data validation \\
Charts                    & \code{test\_charts.py}                                    &  6  & 0 & 0 & Plot helpers \\
UI panels                 & \code{test\_ui\_panels.py}                                & 68  & 0 & 0 & Streamlit panel behavior \\
Coverage and numerics     & \code{test\_coverage\_gaps.py}, \code{test\_strict\_numerics.py}, \code{test\_es\_confidence\_split.py} & 49 & 0 & 0 & Gap-closing and numerical-discipline tests \\
...
\midrule
\textbf{Total}            & &  \textbf{610} & \textbf{0} & \textbf{0} & \\
\bottomrule
\end{tabular}
\end{center}
...
\toprule
\textbf{Case ID} & \textbf{Module} & \textbf{Expected} & \textbf{Actual} & \textbf{Abs.\ error} & \textbf{Pass} \\
\midrule
...
\begin{center}
\begin{tabular}{L{3cm}L{2cm}L{4.5cm}L{3.5cm}l}
\toprule
...
\midrule
Historical & 5 & 0.99 & 990 & 9.90 & 15 & 1.52\% & 0.1300 \\
\bottomrule
\end{tabular}
\end{center}
...
arithmetic — are all tested directly.  The remaining 4\% of uncovered
...
Coverage command                           & Passed (96\% coverage) & No & Gaps documented in Section~10 \\
...
\begin{itemize}
  \item Deterministic formula modules pass all 610 no-network tests.
