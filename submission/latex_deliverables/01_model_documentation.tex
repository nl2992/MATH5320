...
\textbf{Test suite}       & 624 unit tests passing, 95\% statement coverage \\
\end{tabular}
\end{center}
\end{titlepage}
...
\textbf{Validation methodology.}  Validation was performed through a 624-test
no-network unit suite achieving 95\% statement coverage across all source
...
(\code{79111d8}) raised the test suite to 624 tests with 95\% statement
...
statistics; course-validation fixture pass rates; and 95\% statement coverage
...
design; the 624-test no-network unit suite with 95\% statement coverage; two
